...
export default class Onda implements Contract {
        static createForDeploy(code: Cell, jetton_wallet_x_address: Address, jetton_wallet_y_address: Address, jetton_wallet_otoken_address: Address, oracle: Address, owner_address: Address, configuration: Cell): Onda {
                const walletCell = beginCell()
                        .storeAddress(jetton_wallet_x_address)
                        .storeAddress(jetton_wallet_y_address)
